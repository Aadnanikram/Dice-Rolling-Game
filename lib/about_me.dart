            ...
            children: <Widget>[
             ...
             Row(
               ...
               children: [
                 ...
                 SizedBox(width: 10,),
                 Text('Muhammad Adnan Ikram', style: TextStyle(fontSize: 20),),
               ],
             ),
              SizedBox(height: 30,),
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 30,),
                  Text('03004868199', style: TextStyle(fontSize: 20),),
                ],
              ),
              SizedBox(height: 30,),
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10,),
                  Text('adnanikram199@gmail.com', style: TextStyle(fontSize: 20),),
                ],
              ),
